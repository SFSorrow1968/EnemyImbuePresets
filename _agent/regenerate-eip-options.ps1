...
L "using UnityEngine;"
L ""
L "namespace EnemyImbuePresets.Configuration"
L "{"
...
L ""
L "        private const string CategoryPresets = ""Enemy Imbue Presets"";"
...
L "        }"
L ""
L "        [ModOption(name = OptionEnableMod, order = 0, defaultValueIndex = 1, tooltip = ""Master switch for Enemy Imbue Presets."")]"
